...
const body=document.getElementById("marketTableBody"),search=document.getElementById("marketSearch"),sort=document.getElementById("sortSelect"),category=document.getElementById("categorySelect"),more=document.getElementById("loadMore"),status=document.getElementById("marketStatus"),favoritesOnly=document.getElementById("favoritesOnly");
...
if(category.value!=="all"){
 ...
 more.style.display=hasMore&&!search.value.trim()&&(!favoritesOnly.checked)?"":"none";
}
