 ...
 try{
  ...
  try{coin=await fetchCoinData(coinId);}
   ...
   try{
    ...
    coin={
      id:shared.id,name:shared.name,symbol:shared.symbol,
      image:{large:shared.image},
      market_data:{
        current_price:{usd:shared.current_price},
        market_cap:{usd:shared.market_cap},
        total_volume:{usd:shared.total_volume},
        high_24h:{usd:shared.high_24h},
        low_24h:{usd:shared.low_24h},
        circulating_supply:null,
        ath:{usd:null},ath_date:{usd:null},
        price_change_percentage_24h:shared.price_change_percentage_24h
      }
    };
   }
  }
